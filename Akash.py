...
TOKEN = '6915563904:AAGhkSK4y8KdmPcaQ5TAOGTPlddvaujGYUE'
MONGO_URI = 'mongodb+srv://Soul:JYAuvlizhw7wqLOb@soul.tsga4.mongodb.net'
FORWARD_CHANNEL_ID = -1002387084095
CHANNEL_ID = -1002387084095
error_channel_id = -1002387084095
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/SonuDDos/13*", parse_mode='Markdown')
